โครงการนี้เป็น API Server ที่สร้างขึ้นด้วย Node.js และ Express.js โดยมีวัตถุประสงค์เพื่อทำหน้าที่เป็น Middleware สำหรับรวบรวมข้อมูลจาก 2 Servers ภายนอก (ตามที่ระบุในโจทย์) และนำมาจัดเตรียม API Endpoints ให้กับ Client (Frontend) เรียกใช้งาน
